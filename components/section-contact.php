      ...
      <div class="container">
        <div class="row">
          <div class="col-md-5 text-center probootstrap-animate">
            ...
            <p>Aqui você pode: Enviar suas sujestões, tirar dúvidas, mandar depoimentos e até mesmo fazer seus pedidos! <br>
              <strong>Não perca tempo, mande-nos sua mensagem!</strong></p>
          </div>
